...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        Preference prefScale = findPreference(getString(R.string.pref_size_key));
        prefScale.setOnPreferenceChangeListener(this);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Toast error = Toast.makeText(getContext(), "Please enter a numeric value between 0.1 and 3", Toast.LENGTH_SHORT);
        try {
            // FIXME: 17/05/2018 this code will not prevent a value of "1f" being captured - better validation is needed
