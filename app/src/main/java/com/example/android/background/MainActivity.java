...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // TODO (4) If your user is not on M+, then...
            ...
            int chargeStatus = i.getIntExtra(BatteryManager.EXTRA_STATUS, BatteryManager.BATTERY_STATUS_UNKNOWN);
            charging = (chargeStatus == BatteryManager.BATTERY_STATUS_CHARGING) || (chargeStatus == BatteryManager.BATTERY_STATUS_FULL);
        }
