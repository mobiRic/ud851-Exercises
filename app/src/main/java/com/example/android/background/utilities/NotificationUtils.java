...
public class NotificationUtils {
    ...
    public static final String DEFAULT_NOTIFICATION_CHANNEL = "Water Reminder notifications";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel = new NotificationChannel(DEFAULT_NOTIFICATION_CHANNEL, name, importance);
        ...
        String contentText = context.getString(R.string.charging_reminder_notification_body);
        builder
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, REQUEST_CODE_MAIN_ACTIVITY, i, PendingIntent.FLAG_UPDATE_CURRENT);
    }
