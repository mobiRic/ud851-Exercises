...
public class NotificationUtils {
    ...
    private static Action ignoreReminderAction(Context context) {
        ...
        Action action = new Action(R.drawable.ic_cancel_black_24px, "Later", pendingIntent);
    ...
    private static Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, 1, i, PendingIntent.FLAG_UPDATE_CURRENT);

        //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        Action action = new Action(R.drawable.ic_local_drink_black_24px, "Had a glass!", pendingIntent);
