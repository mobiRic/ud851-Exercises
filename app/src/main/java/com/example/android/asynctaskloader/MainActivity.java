...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(KEY_URL)) {
                mUrlDisplayTextView.setText(savedInstanceState.getCharSequence(KEY_URL));
            }
            if (savedInstanceState.containsKey(KEY_JSON)) {
                mSearchResultsTextView.setText(savedInstanceState.getCharSequence(KEY_JSON));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        CharSequence url = mUrlDisplayTextView.getText();
        outState.putCharSequence(KEY_URL, url);
        ...
        CharSequence json = mSearchResultsTextView.getText();
        outState.putCharSequence(KEY_JSON, json);
