...
public class TaskContentProvider extends ContentProvider {
    ...
    private static final int DIRECTORY_TASKS = 100;
    private static final int ITEM_TASK = 101;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS, DIRECTORY_TASKS);
        matcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", ITEM_TASK);
        return matcher;
    }
